-- Second correction to the E2E cleanup helper: question_bank_usages is keyed by
-- lesson_block_id / quiz_question_id (no lesson_id), and standard_links can point at lessons.
