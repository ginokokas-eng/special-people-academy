    ...
    <section className="relative bg-white">
      <div className="container mx-auto max-w-7xl px-6 lg:px-8 pt-4 pb-20 lg:pb-28">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6 mb-16">
          ...
          <article className="relative rounded-[28px] overflow-hidden bg-gradient-to-br from-[#1A1448] via-[#16123E] to-[#0F0B30] p-6 lg:p-8 min-h-[460px] flex flex-col">
            <div aria-hidden className="absolute -top-20 -right-20 w-[320px] h-[320px] rounded-full bg-[hsl(262_83%_58%/0.20)] blur-[110px] pointer-events-none" />
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <div className="font-heading text-[56px] lg:text-[72px] font-bold text-white leading-none tracking-tight tabular-nums">
                47,291
              </div>
